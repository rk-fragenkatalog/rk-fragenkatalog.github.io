    ...
    1: [function (require, module, exports) {
        ...
        class QuizPractice {
            constructor(questions) {
                ...
                this.shuffledIndices = (this.storage.shuffledIndices) ? JSON.parse(this.storage.shuffledIndices) : (0, array_functions_js_1.shuffleArray)([...new Array(this.totalAmountOfQuestions).keys()]);
                this.sections = {
                ...
                this.divs = {
                    ...
                    finalResults: document.getElementById("practice_final_results"),
                };
                this.buttons = {
        ...
        module.exports = {
            "questions": [
                ...
                {
                    "q": "Wie wird die Maßnahme bei einer schweren Verlegung der Atemwege bei Säuglingen bezeichnet, nachdem die Schläge zwischen die Schulterblätter durchgeführt wurden?",
                    "a": [
                        {
                            "aNo": 1,
                            "aT": "Heimlich-Handgriff"
                        },
                        {
                            "aNo": 2,
                            "aT": "Rautek-Griff"
                        ...
                        {
                            "aNo": 3,
                            "aT": "Kompressionsverband"
                        },
                        {
                            "aNo": 4,
                            "aT": "Brustkorbkompression"
                        }
                    ],
                    "c": [
                        4
