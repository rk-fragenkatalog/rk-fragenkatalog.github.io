...
const questions2024_json_1 = require("./questions2024.json");
class QuizExam {
    constructor(questions, articles) {
        ...
        this.checkboxes = []; // equally: HTMLInputElement[][]
        this.checkboxLabels = [];
        this.questions = [];
        this.totalAmountOfQuestions = questions2024_json_1.QUESTION_COUNT;
        this.amountOfQuestionsDisplayed = 20;
        this.shuffledIndices = (0, array_functions_js_1.shuffleArray)([...Array(this.totalAmountOfQuestions).keys()]);
        ...
        this.init();
        this.shuffled25 = (0, array_functions_js_1.shuffleArray)(questions).slice(0, 25);
        this.articles = articles;
        // init buttons
        this.buttons = {
            back: document.getElementById("exam_back"),
    ...
    backToStart() {
        const start = this.articles.namedItem("article_start");
        const exam = this.articles.namedItem("article_exam");
        start.hidden = false;
        exam.hidden = true;
...
},{"./array_functions.js":3,"./questions2024.json":5}],2:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
const array_functions_js_1 = require("./array_functions.js");
const questions2024_json_1 = require("./questions2024.json");
class QuizPractice {
    constructor(questions, articles) {
        ...
        this.shuffledIndices = (this.storage.shuffledIndices) ? JSON.parse(this.storage.shuffledIndices) : (0, array_functions_js_1.shuffleArray)([...Array(this.totalAmountOfQuestions).keys()]);
        this.sections = {
            questionBlock: document.getElementById("practice_question_block"),
            buttonBlock: document.getElementById("practice_button_block"),
            evaluationBlock: document.getElementById("practice_evaluation_block"),
            results: document.getElementById("practice_results"),
        };
        this.divs = {
            question: document.getElementById("practice_question"),
            evaluation: document.getElementById("practice_evaluation"),
            results: document.getElementById("practice_results"),
            progress: document.getElementById("practice_progress"),
        };
        this.buttons = {
            back: document.getElementById("practice_back"),
            submit: document.getElementById("practice_submit"),
            next: document.getElementById("practice_next"),
            resultsBack: document.getElementById("practice_results_back"),
        };
        this.checks = {
            boxes: [],
            labels: [],
        ...
        for (let i = 0; i < 4; i++) {
            this.checks.boxes[i] = document.getElementById(`practice_A${i}`);
            this.checks.labels[i] = document.getElementById(`practice_A${i}_label`);
        }
        // init progress
        this.progress = {
            bar: document.getElementById("practice_progress_bar"),
            label: document.getElementById("practice_progress_label"),
        };
        // event listeners for buttons
    ...
    evaluateAnswer() {
        ...
        correct = (0, array_functions_js_1.compareArrays)(currentQuestion.c, checked);
        if (correct) {
    ...
    backToStart(save = true) {
        const start = this.articles.namedItem("article_start");
        const practice = this.articles.namedItem("article_practice");
        start.hidden = false;
...
exports.default = QuizPractice;

},{"./array_functions.js":3,"./questions2024.json":5}],3:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
buttons.namedItem("button_practice").addEventListener("click", () => {
    ...
    practice = new QuizPractice_js_1.default(questions2025_json_1.questions, articles);
});
buttons.namedItem("button_exam").addEventListener("click", () => {
    articles.namedItem("article_start").hidden = true;
    articles.namedItem("article_exam").hidden = false;
    exam = new QuizExam_js_1.default(questions2025_json_1.questions, articles);
});

},{"./QuizExam.js":1,"./QuizPractice.js":2,"./questions2025.json":6}],5:[function(require,module,exports){
module.exports={
    "QUESTION_COUNT": 88,
    "questions": [
        {
        ...
        },
        {
            ...
            "a": [
                ...
                {
                    "aNo": 3,
                    "aT": "Der:die Ersthelfer:in soll nur den Notruf absetzen"
                },
                {
                    "aNo": 4,
        ...
        },
        {
            ...
            "a": [
                ...
                {
                    "aNo": 4,
                    "aT": "Bewusstseinslage kann durch den Ersthelfer nicht überprüft werden"
                }
            ],
            "c": [
                3
